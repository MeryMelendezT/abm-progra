...
public class _editar extends oracle.jsp.runtime.HttpJsp {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:user-code*//*@lineinfo:14^21*/      out.print((String)session.getAttribute("cod"));
      /*@lineinfo:generated-code*/
      ...
      /*@lineinfo:translated-code*//*@lineinfo:16^1*/      {
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:19^23*/            {
              ...
              __jsp_taghandler_2.setKey("ideditar.prompt");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:21^3*/            {
              ...
              __jsp_taghandler_3.setId("tabla");
              __jsp_taghandler_3.setIndexId("index");
              __jsp_taghandler_3.setName("nn");
              __jsp_taghandler_3.setProperty("tabla");
              ...
              if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
              {
                ...
                do {
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:23^11*/                  {
                    ...
                    __jsp_taghandler_4.setKey("nameeditar.prompt");
                ...
                /*@lineinfo:translated-code*//*@lineinfo:24^53*/                } while (__jsp_taghandler_3.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                out=OracleJspRuntime.popBodyIfNeeded(pageContext,out);
              }
            ...
            /*@lineinfo:translated-code*//*@lineinfo:28^11*/            {
              ...
              __jsp_taghandler_6.setKey("regioneditar.prompt");
              ...
              if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
              {
                ...
                do {
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:30^11*/                  {
                    ...
                    __jsp_taghandler_8.setLabelProperty("name");
                ...
                /*@lineinfo:translated-code*//*@lineinfo:30^81*/                } while (__jsp_taghandler_7.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                out=OracleJspRuntime.popBodyIfNeeded(pageContext,out);
              }
          ...
          /*@lineinfo:translated-code*//*@lineinfo:34^57*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
  ...
  private static class __jsp_StaticText {
    ...
    static {
      ...
      "\n".toCharArray();
      text[3] = 
      "\n<html>\n<head>\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset=windows-1252\">\n<title>\nHello World\n</title>\n</head>\n<body>\n<h2>\nEditar Departamento ".toCharArray();
      text[4] = 
      "\n</h2>\n".toCharArray();
      text[5] = 
